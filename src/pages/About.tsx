        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center mb-24">
            ...
            <Reveal className="order-1 md:order-2" delay={100}>
              <h2 className="text-3xl font-bold text-white mb-4">Nossa Metodologia</h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={i} className="flex items-center text-white font-medium">
                    <span className="h-2 w-2 rounded-full bg-primary mr-3 shadow-glow"></span>
                    {item}
                  </li>
                ))}
              </ul>
        ...
        <div className="container mx-auto px-4">
          <Reveal>
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Nosso Time</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {team.map((member, i) => (
              <Reveal key={i} delay={i * 100}>
                <div className="bg-background border border-border rounded-xl p-6 text-center group hover:border-primary/50 transition-colors">
                  <div className="w-32 h-32 mx-auto rounded-full overflow-hidden border-2 border-border mb-6 group-hover:border-primary transition-colors">
                    <img
                      src={member.img}
                      alt={member.name}
