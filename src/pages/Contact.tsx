          ...
          <Reveal delay={200} className="space-y-12">
            <div>
              ...
              <div className="space-y-8">
                ...
                >
                  ...
                  <p className="font-bold text-foreground text-sm break-all group-hover:text-primary transition-colors duration-300">
            ...
            <div className="h-56 rounded-2xl overflow-hidden border border-border bg-card relative shadow-lg group">
              <img
                ...
                alt="Mapa"
                className="w-full h-full object-cover opacity-60 grayscale mix-blend-multiply dark:mix-blend-lighten transition-all duration-700 group-hover:scale-105 group-hover:grayscale-0 group-hover:opacity-100"
              />
            </div>
          </Reveal>
        </div>
